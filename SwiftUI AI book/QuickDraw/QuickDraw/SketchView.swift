...
extension SketchView{
    ...
    override func beginTracking(_ touch: UITouch, with event: UIEvent?) -> Bool{
        ...
        guard let sketch = self.sketches.last as? StrokeSketch else { return false }
        sketch.addStroke(stroke: Stroke(startingPoint: point, color: self.strokeColor, width: self.strokeWidth))
        self.setNeedsDisplay()
